...
if ctx.video_processor:
    st.write("Parameters")
    ctx.video_processor.RADIUS = int(st.slider("顔の大きさ", min_value=1.0, max_value=500.0, step=1, value=100.0))
    ctx.video_processor.THICKNESS = int(st.slider("手足の太さ", min_value=1.0, max_value=100.0, step=1, value=50.0))
